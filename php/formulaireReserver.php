        ...
        <div class="col-lg-8 col-md-10 col-sm-12 p-4 custom ">
            <form action="" method="post">
                <table class="table text-light">
                    <tr><td><label for="name" class="form-label">Identifiant :</label>
                        <input type="text" id="name" class="form-control input-custom" placeholder="Entrez votre nom" readonly>
                    </td></tr>
                    
                    <tr><td><label for="email" class="form-label">Email :</label>
                        <input type="email" id="email" class="form-control input-custom" placeholder="Entrez votre email" readonly>
                    </td></tr>
                    <tr><td><label for="numero_etudiant" class="form-label">Numéro étudiant :</label>
                        <input type="text" id="numero_etudiant" class="form-control input-custom" placeholder="Entrez votre numéro étudiant">
                    </td></tr>
                    <tr><td><label for="date_acces" class="form-label">Date d’accès souhaitée :</label>
                        <input type="date" id="date_acces" class="form-control input-custom" max="<?= date('Y') ?>-12-31">

                    </td></tr>
                    <tr><td><label for="heure_acces" class="form-label">Heure d’accès (à partir de 8h30) :</label>
                        <input type="time" id="heure_acces" class="form-control input-custom" min="08:30">
                    </td></tr>
                    <tr><td><label for="heure_remisee" class="form-label">Heure de remise des clés (jusqu’à 18h max) :</label>
                        <input type="time" id="heure_remisee" class="form-control input-custom" max="18:00">
                    </td></tr>
                    <tr><td>
                        <label for="annee_etude" class="form-label">Année MMI :</label>
                        <select id="annee_etude" class="form-control input-custom">
                    ...
                    <tr><td><label for="etudiant_concerne" class="form-label">Étudiants concernés / personnel :</label>
                        <input type="text" id="etudiant_concerne" class="form-control input-custom" placeholder="Entrez les personnes concernées">
                    </td></tr>
                    <tr><td><label for="projet" class="form-label">Projet :</label>
